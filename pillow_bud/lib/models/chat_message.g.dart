...
void _chatMessageSerialize(
  ...
  writer.writeBool(offsets[1], object.isFromBud);
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    ...
    isFromBud: reader.readBool(offsets[1]),
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      isFromBudEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isFromBud',
        value: value,
      ));
    });
  }
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsFromBud() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromBud', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByIsFromBudDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromBud', Sort.desc);
    });
  }
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsFromBud() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromBud', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByIsFromBudDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFromBud', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByIsFromBud() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isFromBud');
    });
  }
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, bool, QQueryOperations> isFromBudProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isFromBud');
    });
  }
